        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            ...
            <div className="fade-in-up fade-in-up-delay-3 flex flex-wrap gap-4">
              <a
                href="#services"
                className="inline-flex items-center gap-2 bg-gold-gradient text-primary font-semibold px-8 py-4 rounded-lg cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 animate-pulse-gold"
              >
                Explore Services
              </a>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 border-2 border-primary-foreground/30 text-primary-foreground font-semibold px-8 py-4 rounded-lg cursor-pointer transition-all duration-300 hover:bg-primary-foreground/10 hover:border-primary-foreground/50"
              >
                Get Quote
              </a>
            </div>
          ...
          <div className="fade-in-up fade-in-up-delay-2 relative">
            <div className="relative animate-float">
              ...
              <img
                src={heroGraphic}
                alt="Patent Design Illustration"
                className="relative rounded-3xl shadow-2xl w-full max-w-lg mx-auto"
              />
            </div>
            {/* Floating elements */}
            <div className="absolute -top-8 -left-8 w-20 h-20 bg-gold/30 rounded-full blur-2xl animate-float" style={{ animationDelay: "0.5s" }} />
            <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-gold/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }} />
          </div>
        </div>
      </div>
